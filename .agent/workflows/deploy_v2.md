---
description: How to deploy Version 2.0 and release to Snap Store
---
...
2.  **Build the Snap package**:
    ...
    ```
    *This will generate a file like `video-optimizer_2.0.0_amd64.snap`.*

3.  **Upload to Snap Store**:
    ```bash
    snapcraft upload --release=stable video-optimizer_2.0.0_amd64.snap
    ```
